...
type Info struct {
	...
	OperatorId   string `protobuf:"bytes,2,opt,name=operator_id,proto3" json:"operator_id,omitempty"`
...
func (x *Info) GetOperatorId() string {
	if x != nil {
		return x.OperatorId
	}
	return ""
...
type InfoFilter struct {
	...
	OperatorId   string `protobuf:"bytes,6,opt,name=operator_id,proto3" json:"operator_id,omitempty"`
...
func (x *InfoFilter) GetOperatorId() string {
	if x != nil {
		return x.OperatorId
	}
	return ""
...
var file_proto_helloworld_info_proto_rawDesc = []byte{
	...
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6f, 0x70, 0x65, 0x72,
