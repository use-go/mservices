...
var file_proto_user_handler_proto_goTypes = []interface{}{
	...
	(*SendVerificationEmailResponse)(nil),  // 17: user.SendVerificationEmailResponse
	(*SendPasswordResetEmailResponse)(nil), // 18: user.SendPasswordResetEmailResponse
...
var file_proto_user_handler_proto_depIdxs = []int32{
	...
	14, // 14: user.Account.List:output_type -> user.ListResponse
	15, // 15: user.Account.UpdatePassword:output_type -> user.UpdatePasswordResponse
	16, // 16: user.Account.VerifyEmail:output_type -> user.VerifyEmailResponse
	17, // 17: user.Account.SendVerificationEmail:output_type -> user.SendVerificationEmailResponse
	18, // 18: user.Account.SendPasswordResetEmail:output_type -> user.SendPasswordResetEmailResponse
	19, // 19: user.Account.ResetPassword:output_type -> user.ResetPasswordResponse
